...
const MaintenanceModal = () => {
  ...
  return (
    <div className="w-full bg-amber-400 text-amber-900 font-bold text-center py-2 px-4 shadow-md flex flex-wrap items-center justify-center gap-2 animate-fade-in-down z-50">
